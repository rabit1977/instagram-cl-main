  ...
  return (
    <div className='flex'>
      <Tabs
        ...
        className='min-h-screen space-y-8 left-0 top-0 h-full flex flex-col relative flex-grow max-w-96 border-r py-10 px-8'
        orientation='vertical'
      >
        <h4 className='font-medium text-2xl text-white ml-1'>Settings</h4>
      ...
      <div className='flex  min-h-screen bg-white dark:bg-neutral-950 mx-auto mt-10'>
        {children}
      </div>
    </div>
  );
